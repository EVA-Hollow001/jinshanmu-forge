...
人机团队产物。**AI 参与范围**：初稿生成、结构组织、文案润色；**人类主理范围**：研究方向裁定、数据与结论的最终核验、收山决定、发布。**AI 不豁免验证**：本仓库的每一条数学断言都经过攻击手和机器复核，不因来源而免检。

**关于对外文章的去 AI 味处理（如实说明）**：对外文章（articles/D）初稿为 AI 生成。发布前我们用 stop-slop-zh 五维量规（直/实/变/散/真，50 分制）做了去 AI 味处理，评分从初稿 31 分改到 45/50（删除 14 处破折号、金句收尾、元评论、同句式标题，保留全部真实数据与结论）。**去 AI 味是编辑动作，不是隐瞒来源**——文章开头的 AI 声明与本文档的披露清单共同构成完整来源说明：AI 写的、人改的、真实算的，三者边界可审计。
